...
import { register, selectRegisterStatus, selectErorrStatus } from '../../features/authentication/authenticationSlice'
...
export default () => {
    ...
    return (
        <div id="contact" className="" style={{ display: "flex", justifyContent: "center" }} >
